...
tlgApp.controller('brexitController',['$scope','internationalizationService','Constant.labels','$timeout','$http','$window', function($scope,internationalizationService,Constantlabels,$timeout,$http,$window) {
  $scope.labels_sst= {};
...
// Method to get the successive page questions
        ...
        $scope.submitTool=function(){
            $http({
                ...
                alertify.success($scope.labels_sst.sst_brexit_submit_success_msg);
            }, 
        function(response){
