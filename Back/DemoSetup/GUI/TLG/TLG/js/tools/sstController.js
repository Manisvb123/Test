...
tlgApp.controller('sstController',['$scope','internationalizationService','Constant.labels','$timeout','$http','$window', function($scope,internationalizationService,Constantlabels,$timeout,$http,$window) {
	$scope.labels_sst= {};
